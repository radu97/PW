			...
			<div class="panel panel-primary">
				...
				<div class="row">
						...
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
							<div class="white">
								<p id="acasa">Turismul în România se concentrează asupra peisajelor naturale şi a istoriei sale bogate. Traversată de apele Dunării, România are un scenariu sensibil, incluzând frumoșii și împăduriții Munții Carpați, Coasta Mării Negre şi Delta Dunării, care este cea mai mare deltă europeană atât de bine păstrată. Cu rolul de a puncta peisajele naturale sunt satele, unde oamenii de acolo trăiesc și mențin pentru sute de ani tradițiile. În România este o abundență a arhitecturii religioase și a orașelor medievale și a castelelor.</p>

								<p>În ultimii ani, România a devenit o destinație preferată pentru mulți europeni (mai mult de 60% dintre turiștii străini provin din țările membre UE), rivalizând și fiind la concurență cu țări precum Bulgaria, Grecia, Italia sau Spania. Stațiuni precum Mangalia, Saturn, Venus, Neptun, Olimp și Mamaia (numite uneori și Riviera Română) sunt printre principale atracții turistice pe timp de vară. În timpul iernii, stațiunile de schi de pe Valea Prahovei și din Poiana Brașov sunt destinațiile preferate ale turiștilor străini. Pentru atmosfera lor medievală și pentru castelele aflate acolo, numeroase orașe transilvănene precum Sibiu, Brașov, Sighișoara, Cluj-Napoca sau Târgu Mureș au devenit niște importante puncte de atracție pentru turiști. De curând s-a dezvoltat și turismul rural ce se concentrează asupra promovării folclorului și tradițiilor. Principalele puncte de atracție le reprezintă Castelul Bran, mânăstirile pictate din nordul Moldovei, bisericile de lemn din Transilvania ori Cimitirul Vesel din Săpânța. Alte atracții turistice importante din România sunt cele naturale precum Delta Dunării, Porțile de Fier, Peștera Scărișoara și încă alte câteva peșteri din Munții Apuseni. Bucovina este situată în partea de nord a României, în nord-vestul Moldovei. Regiune montană pitorească, cu tradiții etnografice ce dăinuie nealterate, Bucovina se remarcă printr-o activitate turistică dinamică, datorată în primul rând mânăstirilor. Cele cinci mânăstiri cu pictură exterioară, intrate în patrimoniul turistic mondial, își păstreaza frumusetea după mai bine de 450 de ani.</p>
							</div>
						</div> <!-- end col -->
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<nav class="btn-group-vertical nav-justified">
								...
								<a href="index.php" type="button" class="btn btn-primary active">Introducere</a>
								<a href="istoric.php" type="button" class="btn btn-primary" >Istoric</a>
								<a href="zone.php" type="button" class="btn btn-primary">Zone turistice</a>
								<a href="statistici.php" type="button" class="btn btn-primary">Statistici</a>
